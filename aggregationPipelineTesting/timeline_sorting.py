...
def summarize_articles(articles):
    ...
    Your job is to summarize a set of news articles in up to 5 sentences. In this summary, you should use AT MOST one quote from the articles,
    and you should not directly copy so as to avoid plagiarism. 
